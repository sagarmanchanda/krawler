...
<div style="font-family:Komoda; font-size:70px;">Kra<img src="img/krawler.png" style="display: inline-block; width: 70px;">ler</div>
...
if (empty($output['didyoumean']) && empty($output['results'])) {
	...
	echo "<tr><td><h3>No results found! Did you mean: <b><a href=\"index.php?search_term=".$output['didyoumean']."\">".$output['didyoumean']."</a>?</b></h3></tr></td>";
} else {
